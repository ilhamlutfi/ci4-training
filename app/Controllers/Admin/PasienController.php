...
class PasienController extends BaseController
{
    ...
    public function insert()
    {
        ...
        $rules = $this->validate([
            ...
            'nik' => [
                'rules' => 'required|numeric|is_unique[pasien.nik]|max_length[16]|min_length[16]',
                'errors' => [
    ...
    public function update($id_pasien)
    {
        ...
        if ($getFoto->getError() == 4) {
            // jika tidak upload foto baru tetapkan fotolama
        ...
        return redirect()->to(base_url('pasien'))->with('success', 'Data Pasien Berhasil Diubah');
    }
    ...
    public function delete()
    {
        if ($this->request->isAJAX()) {
            ...
            // SELECT * FROM tbl_pasien WHERE id_pasien = $id_pasien
