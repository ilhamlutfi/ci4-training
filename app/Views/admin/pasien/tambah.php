        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="number" name="nik" id="nik" class="form-control <?= ($validation->hasError('nik') ? 'is-invalid' : ''); ?>" value="<?= old('nik'); ?>">
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <input type="text" name="diagnosa" id="diagnosa" class="form-control <?= ($validation->hasError('diagnosa') ? 'is-invalid' : ''); ?>" value="<?= old('diagnosa'); ?>">
                ...
                <div class="form-group col-6">
                    ...
                    <select name="jenis_rawat" id="jenis_rawat" class="form-control <?= ($validation->hasError('jenis_rawat') ? 'is-invalid' : ''); ?>">
                        <option value="">-- pilih --</option>
                        <option value="Rawat Inap">Rawat Inap</option>
                        <option value="Rawat Jalan">Rawat Jalan</option>
                    </select>

                    <?php if ($validation->hasError('jenis_rawat')) : ?>
                        <div class="invalid-feedback">
                            <?= $validation->getError('jenis_rawat'); ?>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <input type="number" name="biaya" id="biaya" class="form-control <?= ($validation->hasError('biaya') ? 'is-invalid' : ''); ?>" value="<?= old('biaya'); ?>">
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <input type="number" name="no_telepon" id="no_telepon" class="form-control <?= ($validation->hasError('no_telepon') ? 'is-invalid' : ''); ?>" value="<?= old('no_telepon'); ?>">
                ...
                <div class="form-group col-6">
                    ...
                    <?php if ($validation->hasError('foto')) : ?>
                        <div class="text-danger">
                            <small><?= $validation->getError('foto'); ?></small>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
