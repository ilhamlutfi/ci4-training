...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-edit"></i> Ubah Data Rekam Medik</h6>
        </div>
        <div class="card-body">
            <!-- pesan gagal -->
            <?php
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="number" name="nik" id="nik" class="form-control <?= ($validation->hasError('nik') ? 'is-invalid' : ''); ?>" value="<?= old('nik', $pasien->nik); ?>">
            ...
            <div class="row">
                <div class="form-group col-6">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control <?= ($validation->hasError('nama') ? 'is-invalid' : ''); ?>" value="<?= old('nama', $pasien->nama); ?>">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="text" name="alamat" id="alamat" class="form-control <?= ($validation->hasError('alamat') ? 'is-invalid' : ''); ?>" value="<?= old('alamat', $pasien->alamat); ?>">
